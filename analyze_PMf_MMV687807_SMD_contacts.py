...
# Topology is stored in the main PMf_MMV687807_SMD directory.
psf = os.path.join(work_dir, "PMf_MMV687807_nooverlap.psf")

# Forward SMD trajectory: 60 Angstrom over 1.5 ns.
dcd = os.path.join(
    trajectory_dir,
    "PMf_MMV687807_SMD_60A_1p5ns.dcd",
)

output_txt = os.path.join(
    trajectory_dir,
    "PMf_MMV687807_SMD_60A_1p5ns_contacts.txt",
)

output_png = os.path.join(
    trajectory_dir,
    "PMf_MMV687807_SMD_60A_1p5ns_contacts.png",
)
...
# MMV687807 is residue LIG in segment L.
...
if ligand.n_atoms == 0:
    ...
    raise ValueError(
        "No MMV687807 atoms were found using 'segid L and resname LIG'.\n"
        f"Available segids: {available_segids}\n"
        f"Available resnames: {available_resnames}"
    )
...
plt.title(
    "PMf-MMV687807 contacts during SMD\n"
