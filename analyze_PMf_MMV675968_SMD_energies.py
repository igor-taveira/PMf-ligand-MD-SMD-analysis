...
output_csv = os.path.join(
    output_dir,
    "MMV675968_SMD_energy_data.csv"
)

output_summary = os.path.join(
    output_dir,
    "MMV675968_SMD_energy_summary.csv"
)

output_combined = os.path.join(
    output_dir,
    "MMV675968_SMD_energy_components.png"
)

output_global = os.path.join(
    output_dir,
    "MMV675968_SMD_total_potential_kinetic.png"
)

output_temperature = os.path.join(
    output_dir,
    "MMV675968_SMD_temperature.png"
)

output_pressure = os.path.join(
    output_dir,
    "MMV675968_SMD_pressure.png"
)

output_volume = os.path.join(
    output_dir,
    "MMV675968_SMD_volume.png"
)
...
print("=" * 75)
print("NAMD SMD ENERGY ANALYSIS - MMV675968")
print("=" * 75)
...
for col in plot_columns:
    ...
    output_plot = os.path.join(
        output_dir,
        f"MMV675968_SMD_{safe_name}.png"
    )
...
if available_main_terms:
    ...
    plt.title(
        "NAMD Energy Components - MMV675968 SMD"
    )
...
MMV675968_SMD_BOND.png
MMV675968_SMD_ANGLE.png
MMV675968_SMD_DIHED.png
MMV675968_SMD_IMPRP.png
MMV675968_SMD_ELECT.png
MMV675968_SMD_VDW.png
etc.
