...
output_complete_csv = os.path.join(
    output_dir,
    "MMV687807_bound_minus_unbound_energy_difference.csv"
)

output_summary_csv = os.path.join(
    output_dir,
    "MMV687807_bound_minus_unbound_summary.csv"
)

output_components_png = os.path.join(
    output_dir,
    "MMV687807_delta_energy_components.png"
)

output_global_png = os.path.join(
    output_dir,
    "MMV687807_delta_global_energies.png"
)

output_nonbonded_png = os.path.join(
    output_dir,
    "MMV687807_delta_electrostatic_vdw.png"
)

output_mean_png = os.path.join(
    output_dir,
    "MMV687807_mean_energy_differences.png"
)
