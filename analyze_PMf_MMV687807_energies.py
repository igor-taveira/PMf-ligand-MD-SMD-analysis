...
output_csv = os.path.join(
    output_dir,
    "MMV687807_energy_data.csv"
)

output_summary = os.path.join(
    output_dir,
    "MMV687807_energy_summary.csv"
)

output_combined = os.path.join(
    output_dir,
    "MMV687807_energy_components.png"
)

output_global = os.path.join(
    output_dir,
    "MMV687807_total_potential_kinetic.png"
)

output_temperature = os.path.join(
    output_dir,
    "MMV687807_temperature.png"
)

output_pressure = os.path.join(
    output_dir,
    "MMV687807_pressure.png"
)

output_volume = os.path.join(
    output_dir,
    "MMV687807_volume.png"
)
...
print("=" * 75)
print("NAMD ENERGY ANALYSIS - MMV687807")
print("=" * 75)
...
if available_main_terms:
    ...
    plt.title(
        "NAMD Energy Components - MMV687807"
    )
