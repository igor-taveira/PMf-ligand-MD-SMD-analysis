...
#
#   BOUND:
#       PMf + MMV687807 during 60 A / 1.5 ns SMD
#
#   UNBOUND:
#       PMf alone
# ============================================================
...
output_bound_csv = os.path.join(
    output_dir,
    "MMV687807_SMD_bound_energy_data.csv"
)

output_complete_csv = os.path.join(
    output_dir,
    "MMV687807_SMD_bound_minus_unbound_energy_difference.csv"
)

output_summary_csv = os.path.join(
    output_dir,
    "MMV687807_SMD_bound_minus_unbound_summary.csv"
)

output_components_png = os.path.join(
    output_dir,
    "MMV687807_SMD_delta_energy_components.png"
)

output_global_png = os.path.join(
    output_dir,
    "MMV687807_SMD_delta_global_energies.png"
)

output_nonbonded_png = os.path.join(
    output_dir,
    "MMV687807_SMD_delta_electrostatic_vdw.png"
)

output_mean_png = os.path.join(
    output_dir,
    "MMV687807_SMD_mean_energy_differences.png"
)
