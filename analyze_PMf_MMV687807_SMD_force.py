...
conf_file = os.path.join(
    work_dir,
    "SMD_PMF_MMV687807_60A_1p5ns_SMDfolder.conf"
)

output_txt = os.path.join(
    trajectory_dir,
    "PMf_MMV687807_SMD_60A_1p5ns_force_vs_time.txt"
)

output_png = os.path.join(
    trajectory_dir,
    "PMf_MMV687807_SMD_60A_1p5ns_force_vs_time.png"
)
...
plt.title("MMV687807 force during SMD\n60 Å over 1.5 ns")
