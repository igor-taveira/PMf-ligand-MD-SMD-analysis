...
# The trajectory is inside NAMD_PMf_MMV687807_staged
dcd = os.path.join(
    trajectory_dir,
...
output_txt = os.path.join(
    trajectory_dir,
    "PMf_MMV687807_membrane_contacts.txt"
)

output_png = os.path.join(
    trajectory_dir,
    "PMf_MMV687807_membrane_contacts.png"
)
...
# === DEFINE SELECTIONS ===
# Conventional lipids are in MEMB; fungal glycosphingolipids use
# the BMAN and CER160 residue names (distributed across GLPA segments).
...
if membrane.n_atoms == 0:
    ...
    raise ValueError(
        "No membrane atoms were found using MEMB or BMAN/CER160.\n"
...
print(f"MMV687807 atoms: {ligand.n_atoms}")
...
print("Calculating MMV687807–membrane contacts...")
...
plt.title(f"PMf–MMV687807 contacts\ncutoff = {cutoff:.1f} Å")
