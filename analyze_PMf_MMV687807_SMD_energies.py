...
log_file = os.path.join(
    base_dir,
    "energias-SMD-PMf-MMV687807-60A-1p5ns.log"
)

# Folder where ALL analysis outputs will be saved
output_dir = os.path.join(
    base_dir,
    "NAMD_SMD_MMV687807_60A-1p5ns"
)
...
output_csv = os.path.join(
    output_dir,
    "MMV687807_SMD_energy_data.csv"
)

output_summary = os.path.join(
    output_dir,
    "MMV687807_SMD_energy_summary.csv"
)

output_combined = os.path.join(
    output_dir,
    "MMV687807_SMD_energy_components.png"
)

output_global = os.path.join(
    output_dir,
    "MMV687807_SMD_total_potential_kinetic.png"
)

output_temperature = os.path.join(
    output_dir,
    "MMV687807_SMD_temperature.png"
)

output_pressure = os.path.join(
    output_dir,
    "MMV687807_SMD_pressure.png"
)

output_volume = os.path.join(
    output_dir,
    "MMV687807_SMD_volume.png"
)
...
print("=" * 75)
print("NAMD SMD ENERGY ANALYSIS - MMV687807")
print("=" * 75)
...
with open(
    ...
    for line in f:
        ...
        # ----------------------------------------------------
        # Detect NAMD energy column header
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
            ...
            # Truncate unexpected extra values
...
print(
    f"\n[OK] Complete energy table saved:\n"
    f"{output_csv}"
)
...
for col in plot_columns:
    ...
    output_plot = os.path.join(
        output_dir,
        f"MMV687807_SMD_{safe_name}.png"
    )
...
print(
    "\n[OK] Individual parameter plots completed."
)
...
if available_main_terms:
    ...
    plt.title(
        "NAMD Energy Components - MMV687807 SMD"
    )
...
MMV687807_SMD_BOND.png
MMV687807_SMD_ANGLE.png
MMV687807_SMD_DIHED.png
MMV687807_SMD_IMPRP.png
MMV687807_SMD_ELECT.png
MMV687807_SMD_VDW.png
etc.
